...
from promptTemplates import mental_health_template

st.set_page_config(page_title="Physical Fitness Coach", page_icon="🏃🏽")
st.header('Mental health Coach')
st.write('.......')
...
class ContextChatbot:
    ...
    def setup_chain(_self):
        ...
        chain = ConversationChain(llm=llm, prompt=mental_health_template, memory=memory, verbose=True)
        return chain
